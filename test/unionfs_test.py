import ctypes
import os, sys
print(sys.path.append('/home/krishna/Projects/github/dockermock'))
...
flags = 0
below = 1
from_path = "/home/krishna/Projects/UNIONFSTEST/root"
fspath = "/home/krishna/Projects/UNIONFSTEST/TRANSPARENT"
...
# iovecs.extend(str_iovec("copymode", "masquerade"))
