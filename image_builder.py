...
class MiniImageBuilder:
    ...
    def cmd_RUN(self, command):
        ...
        try:
            ...
            # os.chdir(workingDir)  # change to container workingDir
            # Run command inside chroot + workingDir
            subprocess.run(
                [   
                    "chroot", self.rootfs, 
                    "/bin/sh", "-c", command
...
if __name__ == "__main__":
    ...
    builder = MiniImageBuilder("./image_root")
